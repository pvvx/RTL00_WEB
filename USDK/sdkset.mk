...
LIBS =
ifdef USE_GCC_LIB 
all: LIBS +=_wlan _platform_new _wps _websocket _xmodem _mdns gcc m c nosys 
mp: LIBS +=_wlan_mp _platform_new _wps _websocket _xmodem _mdns gcc m c nosys 
else
...
INCLUDES += sdk/component/soc/realtek/8195a/misc/os
INCLUDES += sdk/component/soc/realtek/8195a/misc/driver
...
SRC_C += sdk/component/soc/realtek/8195a/misc/os/mailbox.c 
#SRC_C += sdk/component/os/os_dep/osdep_api.c
SRC_C += sdk/component/os/os_dep/osdep_service.c
#SRC_C += sdk/component/soc/realtek/8195a/misc/os/
...
SRC_C += sdk/component/soc/realtek/8195a/misc/os/freertos_pmu_8195a.c 
